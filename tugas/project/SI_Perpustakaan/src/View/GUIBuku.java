...
public class GUIBuku {
    ...
    private void initComponents(){
        ...
        tabelbuku.setModel(Objection.buku_c.loadDataBuku());
            ...
            public void actionPerformed(ActionEvent ae) {
                // Simpan
                 try{
                    ...
                    Objection.buku_c.insertBuku(kode, judul, pengarang, tahunTerbit, stok);
        ...
        btnEdit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                try{
                    ...
                    String tahunTerbit = tahunterbitext.getText();
                    int stok = Integer.valueOf(stoktext.getText());
                    Objection.buku_c.updateBuku(selectedIndex, kode, judul, pengarang, tahunTerbit, stok);
        ...
        btnHapus.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                // Hapus
                Objection.buku_c.deleteBuku(selectedIndex);
        ...
        tabelbuku.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked (MouseEvent e){
                ...
                selectedIndex = i;
                kodebukutext.setText(Objection.buku_c.loadDataBuku().getValueAt(i, 0).toString());
                judultext.setText(Objection.buku_c.loadDataBuku().getValueAt(i, 1).toString());
                pengarangtext.setText(Objection.buku_c.loadDataBuku().getValueAt(i, 2).toString());
                tahunterbitext.setText(Objection.buku_c.loadDataBuku().getValueAt(i, 3).toString());
                stoktext.setText(Objection.buku_c.loadDataBuku().getValueAt(i, 4).toString());
