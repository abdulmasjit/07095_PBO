...
public class GUIPeminjaman {
    ...
    public String generateNoPinjam(){
        ...
        int jml = Objection.pinjam_c.listPeminjaman().size();
        if(jml>0){
...
//        dtmPeminjaman.getDataVector().removeAllElements();
    ...
    public void cariBuku(){
        try{
            ...
            indexBuku = Objection.buku_c.cari(kodeBuku);;
            ...
            if(indexBuku==-1){
                ...
                int jawab = JOptionPane.showOptionDialog(null, 
                "Kode Buku : "+Objection.buku_c.getDetail(indexBuku).getKodeBuku()+
                "\nJudul : "+Objection.buku_c.getDetail(indexBuku).getJudulBuku()+ 
                "\nStok : "+Objection.buku_c.getDetail(indexBuku).getStok()+
                "\n",
                "Tambah Buku", 
                JOptionPane.YES_NO_OPTION, 
                JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
                ...
                if(jawab == JOptionPane.YES_OPTION){ 
                    ...
                    // Add object book
                    Object[] data = {             
                        Objection.buku_c.getDetail(indexBuku).getKodeBuku(), 
                        Objection.buku_c.getDetail(indexBuku).getJudulBuku(), 
                        1,
    ...
    public void simpanPeminjaman(){
        ...
        if(indexAnggota==-1){
            ...
            Objection.pinjam_c.insertPeminjaman(Objection.buku_c.getDetail(indexBuku), Objection.anggota_c.getDetail(indexAnggota), jumlah, datePinjam, dateKembali);
