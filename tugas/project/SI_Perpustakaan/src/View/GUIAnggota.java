...
public class GUIAnggota {
    ...
    private void initComponents(){
        ...
        cmbJenis = new JComboBox(Objection.ja.jenisAnggota);
        ...
        tabelAnggota.setModel(Objection.anggota_c.loadDataAnggota());
        ...
        btnSimpan.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                try{
                    ...
                    Objection.anggota_c.insertAnggota(noId, nama, noTelp, jenisAnggota);
                    reset();
                    tabelAnggota.setModel(Objection.anggota_c.loadDataAnggota());
        ...
        btnEdit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                try{
                    ...
                    String noTelp = txtNotelp.getText();
                    int jenisAnggota = cmbJenis.getSelectedIndex();
                    Objection.anggota_c.updateAnggota(selectedIndex, noId, nama, noTelp, jenisAnggota);
                    reset();
                    tabelAnggota.setModel(Objection.anggota_c.loadDataAnggota());
        ...
        btnHapus.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                // Hapus
                Objection.anggota_c.deleteAnggota(selectedIndex);
                reset();
                tabelAnggota.setModel(Objection.anggota_c.loadDataAnggota());
        ...
        tabelAnggota.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked (MouseEvent e){
                ...
                selectedIndex = i;
                txtNoid.setText(Objection.anggota_c.loadDataAnggota().getValueAt(i, 0).toString());
                txtNama.setText(Objection.anggota_c.loadDataAnggota().getValueAt(i, 1).toString());
                txtNotelp.setText(Objection.anggota_c.loadDataAnggota().getValueAt(i, 2).toString());
                cmbJenis.setSelectedItem(Objection.anggota_c.loadDataAnggota().getValueAt(i, 3).toString());
